...
class Scene:
    ...
    fps = 15.0
    #: ความยาวหนึ่งลูปเป็นวินาที ถ้าภาพวนกลับมาเหมือนเดิมพอดี (None = ไม่วน)
    #:
    #: ใช้ตอนเบคเก็บลงเครื่อง: จำนวนเฟรมที่ต้องใช้ = loop_seconds × FPS ที่เล่น
    #: ถ้าเบคไม่พอดีลูป เฟรมสุดท้ายกับเฟรมแรกจะไม่ต่อกัน แล้วภาพกระโดดทุกครั้งที่วน
