...
- ทางที่ยังไม่ได้ลองสำหรับภาพลื่น: อัปโหลดเข้าเครื่องผ่าน `MI_03` (§7)
  เก็บได้ถึง 255 frame แล้วเฟิร์มแวร์เล่นวนเอง ไม่ต้องมี process ค้างและไม่มีทราฟฟิก USB
  จึงไม่มีโอกาสค้างเลย ใช้กับภาพลูปได้ แต่ใช้กับ scene ที่ต้องการข้อมูลสดไม่ได้
