...
- เพดาน FPS ที่วัดได้: 55.7 FPS (16 reports, delay 0) — ดู §9.1
- ค่า delay ที่ปลอดภัยทางสายตา: **ยังไม่ยืนยัน** ต้องรัน `bench_fps.py --visual` แล้วดูด้วยตา
- ค่าเริ่มต้นในโปรแกรมยังเป็น delay 8.5 ms ไว้ก่อน จนกว่าจะยืนยันค่าที่ต่ำกว่านี้
