...
ไม่มีเฟรมหลุดเลยแม้ที่ delay 0 แต่ *throughput ผ่านไม่ได้แปลว่าภาพไม่กระพริบ* —
การกระพริบเกิดฝั่งเฟิร์มแวร์ที่เอาเฟรมซึ่งยังมาไม่ครบไปแสดง โปรแกรมจับไม่ได้ ต้องดูด้วยตา:
